...
void hard_fault_handler_c(unsigned int * hardfault_args)
{
	...
	EvbUart1Config2();
    EvbUart1Printf ("[Hard fault handler]\r\n");
    EvbUart1Printf ("R0 = 0x%x\r\n", stacked_r0);
    EvbUart1Printf ("R1 = 0x%x\r\n", stacked_r1);
    EvbUart1Printf ("R2 = 0x%x\r\n", stacked_r2);
    EvbUart1Printf ("R3 = 0x%x\r\n", stacked_r3);
    EvbUart1Printf ("R12 = 0x%x\r\n", stacked_r12);
    EvbUart1Printf ("LR = 0x%x\r\n", stacked_lr);
    EvbUart1Printf ("PC = 0x%x\r\n", stacked_pc);
    EvbUart1Printf ("PSR = 0x%x\r\n", stacked_psr);
    EvbUart1Printf ("BFAR = 0x%x\r\n", (*((volatile unsigned long *)(0xE000ED38))));
    EvbUart1Printf ("CFSR = 0x%x\r\n", (*((volatile unsigned long *)(0xE000ED28))));
    EvbUart1Printf ("HFSR = 0x%x\r\n", (*((volatile unsigned long *)(0xE000ED2C))));
    EvbUart1Printf ("DFSR = 0x%x\r\n", (*((volatile unsigned long *)(0xE000ED30))));
    EvbUart1Printf ("AFSR = 0x%x\r\n", (*((volatile unsigned long *)(0xE000ED3C))));
#endif
